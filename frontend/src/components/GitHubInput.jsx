export default function GitHubInput({ value, onChange }) {
  return (
    <div className="w-full max-w-xl mx-auto relative group">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-zinc-800 to-zinc-800 rounded-xl blur opacity-25 group-hover:opacity-50 transition duration-500"></div>
      ...
      <div className="relative flex items-center bg-[#0a0a0a] premium-border rounded-xl px-4 py-3.5 transition-all focus-within:ring-2 focus-within:ring-zinc-600 focus-within:border-transparent">
        <svg className="w-5 h-5 text-zinc-500 mr-3 shrink-0" fill="currentColor" viewBox="0 0 24 24">
